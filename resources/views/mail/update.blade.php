                      ...
                      <tr>
                        <td class="pc-sm-p-30-20 pc-xs-p-25-10" style="padding: 40px 30px; background: #ffffff; border-radius: 8px" bgcolor="#ffffff" valign="top">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-30 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 800; line-height: 46px; letter-spacing: -0.6px; color: #0dd248; padding: 0 10px" valign="top">If you're interssted about our IPTV service or you'd like some support, please visit our website.</td>
                              </tr>
                              <tr>
                            ...
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; line-height: 30px; letter-spacing: -0.2px; color: #000000; padding: 0 10px" valign="top">If your IPTV subscription is about to expire or it is already expired <strong>Please check our website&nbsp;<br></strong>to know more about our amazing offers.<strong><br></strong></td>
                              </tr>
                              <tr>
                      ...
                      <tr>
                        <td class="pc-sm-p-35-30 pc-xs-p-25-20" style="padding: 40px 30px 32px; background-color: #000000; border-radius: 8px" valign="top" bgcolor="#000000" pc-default-class="pc-sm-p-35-30 pc-xs-p-25-20" pc-default-padding="40px 30px 32px">
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; color: #f9fafa; text-align: center" valign="top">With our complete and large collection of TV channels, never miss your favorite sport games and TV shows. You can be the first one to see your new episode of your favorite TV series.</td>
                              </tr>
                              <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="padding: 13px 17px; border-radius: 8px; background-color: #f4aa28" bgcolor="#f4aa28" valign="top" align="center">
                                                    <a class="pc-fb-font" href="https://www.bobres.co" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Our Store</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="padding: 13px 17px; border-radius: 8px; background-color: #0dd248" bgcolor="#0dd248" valign="top" align="center">
                                                    <a class="pc-fb-font" href="https://www.bobres.co/en/contact" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">Contact</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                        ...
                                        <tr>
                                          <td style="padding: 20px;" valign="top">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                              <tbody>
                                                <tr>
                                                  <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 500; line-height: 24px; letter-spacing: -0.2px; color: #ffffff;" valign="top">Whatsapp Accounts</td>
                                                </tr>
                                                <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; letter-spacing: -0.2px; color: #D8D8D8;" valign="top">www.bobres.co/en/contact</td>
                                                </tr>
                                                <tr>
