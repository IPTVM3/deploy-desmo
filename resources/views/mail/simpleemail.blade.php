                    ...
                    <table style="border-spacing:0;" width="100%">
                        ...
                        <tr>
                            <td class="inner contents center"
                                ...
                                <center>
                                    ...
                                    <p class="description center"
                                       style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;">
                                        <span style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial Narrow&quot;, Arial; font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);">{{ $simple['body1'] }}</span>
                                    </p>

                                  <a class="button" href="{{ $simple['btn_url'] }}" target="_blank">{{ $simple['btn_title'] }}
                                ...
                                <p class="description center"
                                   style="font-family:'Muli','Arial Narrow',Arial;Margin:0;text-align:center;max-width:320px;color:#a1a8ad;line-height:24px;font-size:15px;Margin-bottom:10px;margin-left: auto; margin-right: auto;">
                                    <span style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial Narrow&quot;, Arial; font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);">{{ $simple['body2'] }}</span>
                                </p>
                    ...
                    <center>
                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">
                            ...
                            <nobr><a class="tel" href="tel:2128102899" style="color:#a1a8ad;text-decoration:none;"
                                     target="_blank"><span style="white-space: nowrap">{{$store->phone}}</span></a>
                            </nobr>
                        </p>

                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">
                            or email <a href="mailto:{{$store->email}}"
                                        style="color:#a1a8ad;text-decoration:underline;"
                                        target="_blank">{{$store->email}}</a></p>
                        ...
                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;padding-top:10px;padding-bottom:0px;font-size:15px;color:#a1a8ad;line-height:23px;">
                            © {{$store->name}} <span style="white-space: nowrap">{{$store->address}}t​</span>, <span
                                    style="white-space: nowrap">{{$store->city}}k,</span> <span
                                    style="white-space: nowrap">{{$store->country}}</span>
                        </p>
                    </center>
                </td>
            </tr>
