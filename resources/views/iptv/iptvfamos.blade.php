...
<html lang="en"><head>
    ...
    <meta property="og:url" content="iptvm3u.fr"/>
    <meta property="og:title" content="IPTV Provider | The best IPTV Service Provider" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="The Best IPTV Providers for Android TV, MAG, Roku, Kodi, Apple TV 4K and Fire TV !! Watch Sports, Movies, and PPV at low prices. The Amazing TV iptvm3u.fr is the best premium IPTV subscription service provider in the market." />
    <meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@IPTVM3U" />
...
<meta property="og:url" content="https://iptvm3u.fr/">
		...
		<div class="modal-header">
            ...
            <div class="modal-footer">
                <div class="btn-group-vertical" style="    width: 100%;">
                                        ...
                                        <a style="width: 100%;    border-radius: 50px 20px;"href="/payments/49.99/Premium Package - 6 Months IPTV Subscription" class="btn btn-warning  btn-lg "><span class="glyphicon glyphicon-shopping-cart"></span> Premuim - € 49.99</a>
             
                                        <a style="width: 100%;   margin-top: 3px; background:#24c1dd; color:black;  border-radius: 50px 20px;" href="/payments/39.99/basic Package - 6 Months IPTV Subscription" class="btn  btn-lg "><span class="glyphicon glyphicon-shopping-cart"></span> Basic - € 39.99</a>
	...
	<div class="modal-dialog modal-newsletter">
		<div class="modal-content text-center">
			<form role="form" method="POST" action=""
                    ...
                    <input type="hidden" name="_token" value="wmvCiPW4GlA3bhJ5gITzxdY1MXLN0CXn95wvgihP">
				...
				<div class="modal-body text-center">
                    <h4 style="font-size: 23px; margin: -17px 0 11px 0;">Contact Us To Become Our Reseller</h4>	
 
                    <div class="input-group text-center">
						 
                        <input type="button"  onclick="location.href = 'https://www.bobres.net/en/contact';"  class="btn btn-primary btn-block" value="Whatsapp">
					...
					<div class="row text-center" id="onedevice">
						...
						<div class="col-md-3 col-sm-6 ">
							<div class="pricingTable  red">
								...
								<div class="pricingTable-signup">
									<a href="/payments/49.99/Premium Package -  IPTV Subscription">@lang('amos.buy_now')</a>
								</div>
							</div>
						</div> 
                ...
                <div class="wow fadeInUp contact-info" data-wow-delay="0.4s">
                    <div class="section-title">
                        ...
                        <p>
                            ...
                            Or send message to this email: iptv21m3uiptv@gmail.com, we will response to you within 24 hours!
                        </p>
                    </div>
<br>
                    <p><i class="fa fa-map-marker"></i> 13 Rue Paul Déroulède, 06000 Nice, FRANCE</p>
                    <p><i class="fa fa-comment"></i> iptv21m3uiptv@gmail.com</p>
                </div>
            </div>
