  ...
  <nav class="navbar navbar-default navbar-fixed-top transition">
    ...
    <div class="container" id="HOME">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/home"><img src="{{ asset('iptvamos/images/logo_light_up.png')}}" alt="Image" class="logo-light"> <img src="{{ asset('iptvamos/images/logo_dark_up.png')}}" alt="Image" class="logo-dark"><span class="since">08<br>
