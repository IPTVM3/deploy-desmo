			...
			<div id="content-wrapper" class="col-xs-12">
                <section id="main">
                    ...
                    <header class="page-header" id="header">
                      <h1>@lang('amos.legal')</h1>
                    </header>
                
                    <section id="content" class="page-content page-cms page-cms-2">
                        <h3>@lang('amos.presentation')</h3>
                            <p>@lang('amos.legal_loi')</p>
                            <p>{{config('app.name')}}<br>@lang('amos.inscr')</p>
                            <p>@lang('amos.validity')</p>
                        <h4>
                            @lang('amos.litiges')
                        </h4>
                            <p>
