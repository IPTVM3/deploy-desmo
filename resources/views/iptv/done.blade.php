          ...
          <table class="pc-email-container" width="100%" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin: 0 auto; max-width: 620px;">
              ...
              <tr>
                <td align="left" valign="top" style="padding: 0 10px;">
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tbody>
                      <tr>
                        <td background="https://images.unsplash.com/photo-1551101674-b7fe1fe084ee" bgcolor="#269819" valign="top" style="background-color: #269819; background-image: url('https://images.unsplash.com/photo-1551101674-b7fe1fe084ee'); background-repeat: no-repeat; background-position: center; background-size: cover; border-radius: 8px">
                          <!--[if gte mso 9]>
                                ...
                                <td class="pc-sm-p-24-20-30 pc-xs-p-15-10-20" valign="top" style="padding: 24px 30px 40px;">
                                  ...
                                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td class="pc-fb-font" valign="top" style="padding: 0 10px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 500; color: #ffffff;">@lang('order.happy')</td>
                                      </tr>
                                      <tr>
                                        <td class="pc-xs-fs-30 pc-xs-lh-42 pc-fb-font" valign="top" style="padding: 13px 10px 0; letter-spacing: -0.7px; line-height: 46px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 800; color: #f0b92d">@lang('order.thx')</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                  <!--[if !gte mso 9]><!-->
            ...
            <![endif]-->
                      ...
                      <tr>
                        <td class="pc-sm-p-30-20 pc-xs-p-25-10" style="padding: 40px 30px; background: #ffffff; border-radius: 8px;" bgcolor="#ffffff" valign="top">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-30 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 800; line-height: 46px; letter-spacing: -0.6px; color: #0dd248; padding: 0 10px" valign="top">@lang('order.success')</td>
                              </tr>
                              <tr>
                            ...
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; line-height: 30px; letter-spacing: -0.2px; color: #000000; padding: 0 10px" valign="top">@lang('order.acti1') <b>{{ $order->zip }}</b> <br>@lang('order.acti2')</td>
                              </tr>
                              <tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                    <tbody>
                      <tr>
                        <td class="pc-sm-p-35-30 pc-xs-p-25-20" style="padding: 40px 30px 32px; background-color: #000000; border-radius: 8px" valign="top" bgcolor="#000000" pc-default-class="pc-sm-p-35-30 pc-xs-p-25-20" pc-default-padding="40px 30px 32px">
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; color: #f9fafa; text-align: center" valign="top">@lang('order.incase')</td>
                              </tr>
                              <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="padding: 13px 17px; border-radius: 8px; background-color: #0dd248" bgcolor="#0dd248" valign="top" align="center">
                                                    <a class="pc-fb-font" href="https://wa.me/33751364857" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">+33751364857</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                          ...
                                          <td style="padding: 8px;" valign="top">
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                              <tbody>
                                                <tr>
                                                  <td style="padding: 13px 17px; border-radius: 8px; background-color: #0dd248" bgcolor="#0dd248" valign="top" align="center">
                                                    <a class="pc-fb-font" href="https://wa.me/33753133255" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;">+33753133255</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                        ...
                                        <tr>
                                          <td style="padding: 20px;" valign="top">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; letter-spacing: -0.2px; color: #D8D8D8" valign="top">If You Have Any Problem Or Question Please Contact Us <br><strong>support.lordlyiptv@gmail.com</strong> <br><strong>Www.lordly-iptv.com</strong></td>
                                                </tr>
                                                <tr>
