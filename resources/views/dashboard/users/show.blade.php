        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <p  class="text-muted"><span>{{'@'.ucfirst(Auth::user()->name)}}</span> <br> @lang('site.membersince') {{  Auth::user()->created_at->diffForHumans()   }}</p>
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                     src="{{asset('img/'.$user->picture)}}" alt="User profile picture">
                            </div>

                            <h3 class="profile-username text-center">{{ucfirst($user->last_name)}} {{ucfirst($user->first_name)}}</h3>
