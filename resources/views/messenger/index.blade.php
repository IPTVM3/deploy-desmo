...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('messenger/assets/images/favicon.png')}}">
    <title>{{ \App\Store::first()->name }}LTE | @lang('messenger.messanger'))</title>
    <!-- Bootstrap Core CSS -->
    <link href="{{asset('messenger/assets/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Animation CSS -->
    <link href="{{asset('messenger/assets/css/animate.css')}}" rel="stylesheet">
    <link href="{{asset('messenger/assets/css/custom.css')}}" rel="stylesheet" id="style">
    <!-- Theme light dark version CSS -->
    <link href="{{asset('messenger/assets/css/style.css')}}" rel="stylesheet">
    <link href="{{asset('messenger/assets/css/style-light.css')}}" id="maintheme" rel="stylesheet">
    <!-- color CSS you can use different color css from css/colors folder -->
    <!-- We have chosen the skin-blue (blue.css) for this starter
         page. However, you can choose any other skin from folder css / colors .
    -->
    <link href="{{asset('messenger/assets/css/colors/green.css')}}" id="theme" rel="stylesheet">
    <!-- Emoji One JS -->
    <link rel="stylesheet" href="{{asset('messenger/smiley/assets/sprites/emojione.sprites.cs')}}s"/>
    <script src="{{asset('messenger/smiley/js/emojione.min.js')}}"></script>
        ...
        <div tabindex="-1" class="wchat two">
                    ...
                    <div class="pane pane-intro" id="pane-intro" style="visibility: visible">
                        <div class="intro-body">
                            ...
                            <div class="intro-text-container" style="opacity: 1; transform: translateY(0px);">
                                <h1 class="intro-title">@lang('messenger.welcome')</h1>
                                <div class="intro-text">@lang('messenger.description')
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="contact-list">
                        <header class="wchat-header wchat-chat-header top">
                            <div class="chat-avatar">
                                <div class="avatar icon-user-default" style="height: 40px; width: 40px;">
                                    <div class="avatar-body userimage"><img src="{{asset('img/'.\App\Store::first()->logo) }}"
                            ...
                            <div class="chat-body">
                                <div class="chat-main"><h2 class="chat-title" dir="auto"><span
                                                class="wchatellips personName">{{ \App\Store::first()->name }} @lang('messenger.messanger')</span>
                                    </h2></div>
                            </div>
                                ...
                                <div class="menu menu-horizontal">
                                    <div class="menu-item active dropdown pull-right">
                                        ...
                                        <button class="icon dropdown-toggle" data-toggle="dropdown" href="#"><span
                                                    class="font-19"><i class="icon icon-options-vertical"></i></span>
                                        </button>
                                        <ul class="dropdown-menu dropdown-user animated flipInY">
                                            <li><a href="{{ route('profile.show') }}"><i class="ti-user"></i> @lang('site.profile')</a></li>
                                            <li><a href="#">  @lang('messenger.language')</a></li>
                                            ...
                                            <form id="logout-form" action="{{ route('logout') }}" method="GET">
                                                ...
                                                <button type="submit" style="background-color: white;border: none"
                                                        class="btn btn-default btn-flat float-right"><i class="fa fa-power-off"></i> @lang('messenger.logout')</button>
                                            </form>
                                    ...
                                    <div >
                                       <a href="{{ url('dashboard') }}"> <button class="icon ti-home font-20" title="@lang('site.home')"></button></a>
                                        <span></span></div>
                                </div>
                            </div>
                        </header>
                        <div class="form-material">
                            <input class="form-control p-lr-20 live-search-box search_bg" id="searchbox" type="text"
                                   placeholder="@lang('messenger.search_by')">
                        </div>
                        <div class="contact-drawer">
                            <ul class="chatonline drawer-body contact-list" id="display"
                                ...
                                <li class="person chatboxhead active" id="chatbox1_Deven" data-chat="person_1"
                                    href="javascript:void(0)"
                                    onclick="javascript:chatWith('Deven','1','deven.jpg','Online')">
                                    <a href="javascript:void(0)">
                                        <span class="userimage profile-picture min-profile-picture"><img
                                                    src="storage/user_image/Deven.jpg" alt="Deven"
                                                    class="avatar-image is-loaded bg-theme" width="100%"></span>
                                        <span>
                                            <span class="bname personName">Deven Patel</span>
                                            <span class="personStatus"><span class="time Online"><i class="fa fa-circle"
                                                                                                    aria-hidden="true"></i></span></span>
                                            <span class="count"><span class="icon-meta unread-count">2</span></span><br>
                                            <small class="preview"><span class="Online">@lang('messenger.online')</span></small>
                                        </span>
                                    </a>
                                </li>
            ...
            <div tabindex="-1" id="main right" class="pane wchat-chat wchat-two chat-right-aside right"
                ...
                <header class="wchat-header wchat-chat-header top" data-user="">
                    ...
                    <div class="chat-body">
                        <div class="chat-main"><h2 class="chat-title" dir="auto"><span class="wchatellips personName">&nbsp;</span>
                            </h2></div>
                            ...
                            <div class="menu-item active dropdown pull-right">
                                ...
                                <ul class="dropdown-menu dropdown-user animated flipInY">
                                    <li><a href="javascript:void(0)"><i
                                                    class="ti-user"></i> @lang('messenger.user_profile')</a></li>
                                    <li><a href="javascript:void(0)"><i
                                                    class="fas fa-trash-alt"></i> @lang('messenger.delete_conversion')
                                        </a></li>
                                </ul>
                                <!-- /.dropdown-user -->
                            </div>
                        ...
                        <div class="wchat-chat-msgs wchat-chat-body lastTabIndex" tabindex="0">
                            ...
                            <div class="message-list">
                                <div class="chat-list" id="resultchat">
                                    ...
                                    <div id="chatbox_Deven" class="chat chatboxcontent active-chat" data-chat="person_1"
                                         client="Deven">
                                        <div class="col-xs-12 p-b-10">
                                            ...
                                            <div class="chat-body">
                                                <div class="chat-text">
                                                    <h4>Deven Patel</h4>
                                                    <p><a url="storage/user_files/image-chat.jpg" onclick="trigq(this)"><img
...
<div class="right-sidebar">
    <div class="slimscrollright">
        <div class="rpanel-title">  @lang('messenger.theme_modify')<span><i
        ...
        <div class="r-panel-body">
            ...
            <ul id="mainthemecolors" class="m-t-20">
                <li><b>@lang('messenger.language')</b></li>
                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            ...
                            <li>
                                <a  hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}"
                                  ><b style="color: black">{{ ucfirst($properties['native']) }}</b>
                                </a>
                            </li>
...
<!-- jQuery -->
<script src="{{asset('messenger/plugins/bower_components/jquery/dist/jquery.min.js')}}"></script>
<!-- Bootstrap Core JavaScript -->
<script src="{{asset('messenger/assets/bootstrap/dist/js/bootstrap.min.js')}}"></script>
<!-- Custom Theme JavaScript -->
<script src="{{asset('messenger/assets/js/custom.js')}}"></script>
<!--Style Switcher -->
<script src="{{asset('messenger/plugins/bower_components/styleswitcher/jQuery.style.switcher.js')}}"></script>
<!--Style Switcher -->
<!--ChatJs -->
<script type="text/javascript" src="{{asset('messenger/chatjs/lightbox.js')}}"></script>
<script type="text/javascript" src="{{asset('messenger/chatjs/inbox.js')}}"></script>
<script type="text/javascript" src="{{asset('messenger/chatjs/custom.js')}}"></script>
