...
f = open(r"G:\getAllChannels\movies.txt", encoding="utf8")
content = f.read().splitlines()
all_codes= []
all_ = ""
for line in content: 
    code = between(line,"|","|") 
    channel = after(line,"|"+code+"|")    
    print('<li class="list-group-item d-flex justify-content-between align-items-center">'+channel+'<span class="badge badge-primary badge-pill">'+code+'</span></li>')        
